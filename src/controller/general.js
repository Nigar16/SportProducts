...
const productAdd=async(req,res)=>{
    try{
        const {product_title,category_title,amount,products_price}=req.query;
        const addProduct= await generalModel.addProduct(product_title,category_title,amount,products_price);
        res.json({
            data:addProduct,
            status:"success"
        })
